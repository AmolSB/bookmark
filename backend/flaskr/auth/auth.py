...
def check_permissions(permission, payload):
    ...
    Returns:
        ...
        abort if persmission is not present in the payload
    """
...
def verify_decode_jwt(token):
    """ Verify the jwt token. This boilerplate is provided by Auth0

    Args:
        token (string): JWT token

    Returns:
        python dict: return the payload present in JWT.
    """
